  ...
  _createClass(ItineraryCarousel, [{
    ...
    value: function render() {
      ...
      var _this$props3 = this.props,
          ...
          showProfileSummary = _this$props3.showProfileSummary;
      ...
      if (showProfileSummary) {
        views.push(_react.default.createElement("div", {
          style: {
            padding: '6px 10px'
          }
        ...
        }, "Your Best Options (Swipe to View All)"), _react.default.createElement(_narrativeProfileSummary.default, {
...
_defineProperty(ItineraryCarousel, "propTypes", {
  ...
  showProfileSummary: _propTypes.default.bool,
  profileOptions: _propTypes.default.array,

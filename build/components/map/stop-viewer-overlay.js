...
function (_MapLayer) {
  ...
  _createClass(StopViewerOverlay, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (hasNewStopId) this.context.map.setView([nextStop.lat, nextStop.lon]);
    }
  }, {
...
var _default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(StopViewerOverlay);

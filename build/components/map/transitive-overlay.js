...
function (_MapLayer) {
  ...
  _createClass(TransitiveCanvasOverlay, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (this._transitive && !(0, _lodash.default)(prevProps.transitiveData, this.props.transitiveData)) {
        this._transitive.updateData(this.props.transitiveData);

        if (!this.props.transitiveData) this._transitive.render();else this._updateBoundsAndRender();
      }

...
var MobileDateTimeScreen =
/*#__PURE__*/
function (_Component) {
  _inherits(MobileDateTimeScreen, _Component);
  ...
  function MobileDateTimeScreen() {
    ...
    _classCallCheck(this, MobileDateTimeScreen);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(MobileDateTimeScreen)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(MobileDateTimeScreen, [{
    key: "render",
    value: function render() {
      ...
      }, _react.default.createElement(_dateTimeModal.default, null)), _react.default.createElement("div", {

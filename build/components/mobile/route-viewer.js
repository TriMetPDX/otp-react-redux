...
var MobileRouteViewer =
/*#__PURE__*/
function (_Component) {
  _inherits(MobileRouteViewer, _Component);
  ...
  function MobileRouteViewer() {
    ...
    _classCallCheck(this, MobileRouteViewer);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(MobileRouteViewer)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(MobileRouteViewer, [{
    key: "render",
    value: function render() {
      ...
      }, _react.default.createElement(_routeViewer.default, {
        hideBackButton: true
      })));
    }
  }]);

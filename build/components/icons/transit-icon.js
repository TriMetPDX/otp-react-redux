...
/*#__PURE__*/
function (_Component) {
  _inherits(TransitIcon, _Component);

  function TransitIcon() {
    _classCallCheck(this, TransitIcon);

    return _possibleConstructorReturn(this, _getPrototypeOf(TransitIcon).apply(this, arguments));
  }

  _createClass(TransitIcon, [{
    key: "render",

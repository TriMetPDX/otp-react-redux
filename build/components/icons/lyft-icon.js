...
/*#__PURE__*/
function (_Component) {
  _inherits(LyftIcon, _Component);

  function LyftIcon() {
    _classCallCheck(this, LyftIcon);

    return _possibleConstructorReturn(this, _getPrototypeOf(LyftIcon).apply(this, arguments));
  }

  _createClass(LyftIcon, [{
    key: "render",

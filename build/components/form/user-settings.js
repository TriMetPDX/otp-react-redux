  ...
  function Place() {
    ...
    _defineProperty(_assertThisInitialized(_this3), "_onSelect", function () {
      ...
      if (location.blank) {
        ...
        if (!query.to && (!query.from || !(0, _map2.matchLatLon)(location, query.from))) setLocation({
          type: 'to',
          location: location
        }); // Vice versa for setting as 'from'.
        else if (!query.from && !(0, _map2.matchLatLon)(location, query.to)) setLocation({
          type: 'from',
          location: location
        });
      }
  ...
  _createClass(Place, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("li", {
        ...
        bsStyle: "link",
        title: (0, _map2.formatStoredPlaceName)(location),
        ...
        type: icon
      }), " ", (0, _map2.formatStoredPlaceName)(location, false)), _react.default.createElement("span", {
        className: "place-detail"
      }, (0, _map2.getDetailText)(location))), showView && _react.default.createElement(_reactBootstrap.Button, {
...
function (_Component3) {
  ...
  _createClass(RecentSearch, [{
    ...
    value: function render() {
      ...
      var name = (0, _query.summarizeQuery)(query, user.locations);
      return _react.default.createElement("li", {
        className: "place-item"
      }, _react.default.createElement(_reactBootstrap.Button, {
        bsStyle: "link",
